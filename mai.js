...
const artist_name = ['Guns N Roses','Queen','Yung kai','Evanescence',' Charita Utamy dan Fourtwnty','Sia','Neffex','Neffex','Akon','Indila','Wiz Khalifa','Michael Buble','Teriyaki Boyz','Lagu Bruno Mars dan Lady Gaga ','Rose dan Bruno Mars','Linkin Park','Guns N Roses'];
const artist_title = ['November Rain','Bohemian Rhapsody','Blue','Bring Me to Life','Mangu','Chandelier','Grateful','Fight Back','Lonely','Love Story','See You Again','Feeling Good','Tokyo Drift','Die With a Smile','APT','Numb','Sweet Child O Mine'];
